...
import Searchcar from '../../comps/Searchcar';

const carforsale = ({ cardata, provinces, carbrand, year, paramsquery }) => {
    ...
    const Breadcrumb1 = () => {
        return (
            <Breadcrumb>
                ...
                <Breadcrumb.Item active>รถ</Breadcrumb.Item>
            </Breadcrumb>
        )
    }
        ...
        <div className='container'>
            ...
            <div className='row'>
                <div className='col-3 d-none d-xl-block'>
                    <Searchcar paramsquery={paramsquerys} carbrands={carbrand} provinces={provinces} year={year}/>
                </div>
                <div className='col'>
...
export async function getServerSideProps(context) {
    const { query } = context
    var fetchcar = `http://localhost:3333/carforsale?page=1&page_size=25`
